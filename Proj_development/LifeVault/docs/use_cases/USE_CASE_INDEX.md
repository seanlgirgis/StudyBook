...
| UC_009 | Cleanup Source After Verification | implemented (temp-only quarantine-only v0; blocked by UC_008 pass) | high | UC_008 successful verification, explicit approval, `docs/use_cases/UC_009_CLEANUP_SOURCE_AFTER_VERIFICATION_WORKFLOW_SPEC.md` | Run temp dry-run + approved quarantine checks; perform real dry-run review before any real cleanup |
