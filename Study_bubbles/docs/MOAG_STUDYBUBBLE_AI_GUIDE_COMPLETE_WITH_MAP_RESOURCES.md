...
- mapResources exist when the whole map needs tutorial, lab, parent, sibling,
  next-map, glossary, checklist, or setup links.
...
Use mapResources for whole-map tutorials, labs, setup guides, parent maps,
sibling maps, next maps, glossary, checklist, or reference links.
