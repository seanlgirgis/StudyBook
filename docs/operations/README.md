...
- `docs/operations/JOBSEARCH_AGENT_HANDOFF.md` - single handoff for any agent covering JobSearch workflow, resume/cover build pipeline, and required tracking updates
