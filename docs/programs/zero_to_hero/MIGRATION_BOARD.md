...
| C-002 | P0 | security | Map cloud secrets to encrypted env flow | `config/secrets/*.enc.json` | runtime env contract | key presence checks recorded | in_progress | mapping defined; account-specific key population still pending |
