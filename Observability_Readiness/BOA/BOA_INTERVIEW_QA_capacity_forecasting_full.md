...
- [BOA Interview Q and A: Capacity Forecasting (Full Defense)](#boa-interview-q-and-a-capacity-forecasting-full-defense)
  ...
  - [36) How does this map to BOA-style CBFR work?](#36-how-does-this-map-to-boa-style-cbfr-work)
  - [37) How do performance testing, TPS, and safety factors fit?](#37-how-do-performance-testing-tps-and-safety-factors-fit)
...
## 41) How do UCL testing, BreakPoint, TPS, and project assessment fit?
[Back to TOC](#table-of-contents)
Performance testing gives a controlled view of upper capacity limits. If a UCL
or BreakPoint-style feed shows TPS capacity, saturation behavior, or upper
limits, I would use that as an input to capacity planning.

Production telemetry shows the real operating baseline. Performance testing
helps define safe operating limits, CPU thresholds, safety factors, and the
point where additional volume may become risky.

For project assessment, I would compare expected new volume or TPS growth
against the current production baseline, capacity pool behavior, headroom,
thresholds, and safety margin.

Then the recommendation becomes practical: can the current production pool
