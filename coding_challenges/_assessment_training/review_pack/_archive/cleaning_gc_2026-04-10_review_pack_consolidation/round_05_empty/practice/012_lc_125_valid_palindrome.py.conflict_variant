...
def isPalindrome(s: str) -> bool:
    # To implment the solution, I will use 2 pointers
    l, r = 0, len(s)-1
    
    while l < r:
        while l < r and not s[l].isalnum(): l += 1                 #skip non alphanumeric
        while l < r and  not s[r].isalnum(): r -= 1                 #skip non alphanumeric
