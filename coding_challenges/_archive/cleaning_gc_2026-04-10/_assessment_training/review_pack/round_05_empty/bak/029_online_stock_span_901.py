...
class StockSpanner:
    def __init__(self):
        # Stack will store pairs of (price, span_for_that_price)
        # This maintains a strictly monotonically decreasing order of prices
        self.stack = []
    ...
    def next(self, price: int) -> int:
        ...
        # or equal to the top price, we pop the top element and accumulate its span.
