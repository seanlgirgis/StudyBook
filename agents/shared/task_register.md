...
| TB-20260602-01 | Initialize DataCamp SQL Course 06 study/source shell | done | 2026-06-02 | Created requested course shell folders/files under `study_maps`, appended track session note, and confirmed no tutorial lab folder was created |
| TB-20260602-02 | Update DataCamp SQL Course 06 chapter 1 source transcript | done | 2026-06-02 | Replaced placeholder `chapter_01_raw_transcript.md` with the provided Chapter 1 opening transcript and confirmed no tutorial lab folder was created |
| TB-20260603-01 | Create DataCamp SQL Course 06 Artifact 1 field guide | done | 2026-06-03 | Created first-pass markdown and HTML field guide files, matched Course 05 styling spirit locally, updated session state, and confirmed no tutorial lab folder was created |
| TB-20260603-02 | Verify and repair Course 06 Artifact 1 HTML lookup page | done | 2026-06-03 | Verified markdown and HTML, repaired HTML to exact lookup requirements, validated file integrity/content checks, updated session state, and confirmed no tutorial lab folder was created |
| TB-20260603-03 | Upgrade Course 06 Artifact 1 into robust reference guide | done | 2026-06-03 | Upgraded markdown and HTML into fuller study/reference guides, validated required HTML content and size checks, updated session state, and confirmed no tutorial lab folder was created |
| TB-20260603-04 | Create Course 06 runnable lab shell | done | 2026-06-03 | Created the tutorials lab shell folders and placeholder docs only, updated session state, confirmed the SQL folder is empty, and did not touch Study_bubbles |
| TB-20260603-05 | Start controlled DataCamp learning-root restructure shell | blocked | 2026-06-03 | Rename of `study_maps\\DataCamp` to `study_maps\\DataCamp.old` failed with access denied in both PowerShell and `cmd`; empty `courses`, `tracks`, `projects`, `docs`, and `assets` folders were created inside the existing root before the run was stopped |
| TB-20260603-06 | Create canonical DataCamp learning shell | done | 2026-06-03 | Created new `study_maps\\DataCamp` shell with placeholder root/docs files, validated requested paths, and did not migrate content or touch `tutorials\\DataCamp` / `Study_bubbles` |
| TB-20260603-07 | Migrate Students Mental Health project slice | done | 2026-06-03 | Created canonical study/tutorial project roots, copied approved study/docs/tutorial assets from `DataCamp.old`, added support files, updated migration log, and preserved all old content |
| TB-20260603-08 | Migrate Course 05 canonical course slice | done | 2026-06-03 | Created canonical study/tutorial course roots for Course 05, copied useful non-empty study/source/tutorial assets, added course navigation pages, updated root links and migration log, and preserved all old content |
| TB-20260603-09 | Create DataCamp career track placeholders | done | 2026-06-03 | Created tracks landing page plus 28 placeholder track folders/pages, updated root links and migration log, and left old content and `Study_bubbles` untouched |
| TB-20260603-10 | Split track model into career and skill track placeholders | done | 2026-06-03 | Created `career_tracks` and `skill_tracks` roots, added 12 skill-track placeholder folders/pages, updated root docs and migration log, and preserved old content and `Study_bubbles` |
| TB-20260603-11 | Create DataCamp course BOM for Functions for Manipulating Data in PostgreSQL | done | 2026-06-03 | Created BOM, curriculum outline, and raw transcript placeholder under the canonical course folder; `git status --short` passed and requested `tree_dit.ps1` validation could not run because the script is not present in the repo |
| TB-20260607-01 | Write DataCamp architecture handoff report for future track creation | done | 2026-06-07 | Added `study_maps/DataCamp/DATACAMP_STUDYBOOK_ARCHITECTURE_REPORT.md`, captured current course/project/track wiring, and parked placeholder inconsistencies for later cleanup |
| TB-20260607-02 | Fix and run Developing AI Applications scaffold script | done | 2026-06-07 | Repaired the parse failure in `scaffold_developing_ai_applications.ps1`, normalized generated track-page separators, and executed the scaffold successfully with `-Force` |
| TB-20260609-01 | Fix and run Working with Hugging Face prepare script | done | 2026-06-09 | Replaced case-colliding replacement hashtables with ordered replacement entries in `prepare_working_with_hugging_face.ps1`, ran the script successfully, and verified the course now uses `hugging_face_quick_lookup.html` plus `lab\\python` |
