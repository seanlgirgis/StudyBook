...
What Pydantic Is | BaseModel & Field Types | Field() Constraints | Validators | model_dump & Serialization | Pipeline Config Validation | Nested Models | Strict vs Lax Mode | Error Handling & v1 vs v2
