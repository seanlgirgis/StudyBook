...
```powershell
Test-Path "..\jobsearch\data\interview_prep\audio_prep\aws-ec2\audio_script_aws-ec2.md"
```
...
.\scripts\run_mission_audio.ps1 `
  "..\jobsearch\data\interview_prep\audio_prep\aws-ec2\audio_script_aws-ec2.md" `
  -ChunkSize 750 `
